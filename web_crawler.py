...
class WebScraper:
    ...
    def extract_main_content(self, html_soup, rule=0):
        ...
        for tag in html_soup.find_all(tag_rule):
            ...
            if tag_text and len(tag_text.split()) > 1:
...
if __name__ == "__main__":
    ...
    test_url = "https://csai.jbnu.ac.kr/csai/29106/subview.do?enc=Zm5jdDF8QEB8JTJGYmJzJTJGY3NhaSUyRjQ5MjglMkYzMjk0OTklMkZhcnRjbFZpZXcuZG8lM0Y%3D"

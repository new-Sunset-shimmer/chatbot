...
class GPTAnswer:
    ...
    def __init__(self):
        ...
        model_checkpoint_Llama = 'llama3:instruct'
        model_checkpoint_Llama_ko = 'llama3:ko16'
        model_checkpoint_mistral = 'mistral:instruct'
        model_checkpoint_Phi3 = 'phi3:instruct'
        model_checkpoint = model_checkpoint_Phi3
